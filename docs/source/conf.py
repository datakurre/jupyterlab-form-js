...
# -*- coding: utf-8 -*-
#
# jupyterlab_form_js documentation build configuration file
#
...
project = 'jupyterlab_form_js'
copyright = '2023, Asko Soukka'
author = 'Asko Soukka'
...
_version_py = os.path.join(repo, 'jupyterlab_form_js', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab_form_jsdoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_form_js.tex', 'jupyterlab_form_js Documentation',
     'Asko Soukka', 'manual'),
]
...
man_pages = [
    (master_doc,
    'jupyterlab_form_js',
    'jupyterlab_form_js Documentation',
     [author], 1)
]
